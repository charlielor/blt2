    ...
    selectShipperModal.on("show.bs.modal", function() {
        ...
        $.getJSON('shippers', function(results) {
            if (results['result'] == "success") {
                ...
                listOfShippers.push('<div class="row shipperRow"><div class="col-md-12"><button type="button" id="addANewShipper" class="btn btn-default btn-lg btn-block text-center" data-toggle="modal" data-target="#shipperModal" data-referer="new" data-page="receiving" data-select2=false>Add new Shipper</button></div></div>');
